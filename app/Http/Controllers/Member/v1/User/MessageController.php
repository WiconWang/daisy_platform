...
namespace App\Http\Controllers\Member\v1\User;
...
class MessageController extends Controller
{
    ...
    {
        $this->responseJson('SUCCESS','',$this->messageService->countMessages(Auth::id(),1,0));
    }
    ...
    public function index()
    {
        $this->responseJson('SUCCESS','',array(
            'unread' => $this->messageService->getRows(Auth::id(),1,0),
            'readed' => $this->messageService->getRows(Auth::id(),1,1),
            'trash' => $this->messageService->getRows(Auth::id(),1,2),
        ));
